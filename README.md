...
本エンコーダインタフェースライブラリは多摩川精機株式会社のT-format<sup>Ⓡ</sup>互換の高機能通信ライブラリです。

RZ/T2Mでは最大8個のエンコーダと同時に通信可能です。(ルネサス社提供のライブラリでは最大2個まで)

下記の多摩川精機株式会社製アブソリュートエンコーダで動作することを確認しています。
- TS5702N40 （2.5Mbps）
- TS5702N142（5Mbps）

※「T-format」は多摩川精機株式会社の登録商標です
